...
namespace HtmlAgilityPack
{
    ...
    public partial class HtmlNode
    {
        ...
        /// <summary>An empty array of <see cref="HtmlNode"/>s</summary>
        public static readonly HtmlNode[] emptyNodes = new HtmlNode[] { };
        ...
        /// </summary>
        /// <param name="outText">The TextWriter to which you want to save.</param>
        public virtual void WriteTo(TextWriter outText)
        {
            string html;
            switch (_nodetype)
            {
                ...
                case HtmlNodeType.Text:
                    ...
                    {
                        html = ((HtmlTextNode)this).InnerHtml;
                        outText.Write(html);
                    }
                    break;
        ...
        /// <summary>Returns a string that represents the current object (HTML code).</summary>
        /// <returns>A string that represents the current object (<see cref="OuterHtml"/>).</returns>
        ...
        string IHtmlNode.Value { get { return InnerText; } }
