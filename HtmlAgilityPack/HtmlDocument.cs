...
namespace HtmlAgilityPack
{
	...
	public partial class HtmlDocument
	{
        ...
        /// <summary>A regular expression used for HTML encoding</summary>
        private static readonly Regex htmlEncodeRegex = new Regex("&(?!(amp;)|(lt;)|(gt;)|(quot;))", RegexOptions.IgnoreCase | RegexOptions.Compiled | RegexOptions.CultureInvariant);
        ...
        /// <summary>Returns a string that represents the current object (HTML code of the document).</summary>
        /// <returns>A string that represents the current object - HTML code of document.</returns>
